...
// Read debuggui.cpp for more details, documentation and comments.
...
// In other debuggui sources we can use nicer internal functions from imgui_internal.h (ImMin/ImMax) but not in the demo.
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    IM_ASSERT(ImGui::GetCurrentContext() != NULL && "Missing dear debuggui context. Refer to examples app!");
    ...
    ImGui::Text("dear debuggui says hello! (%s) (%d)", IMGUI_VERSION, IMGUI_VERSION_NUM);
    ImGui::Spacing();
    ...
    if (ImGui::CollapsingHeader("Help"))
    {
        ...
        ImGui::BulletText("See comments in debuggui.cpp.");
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Enable gamepad controls. Require backend to set io.BackendFlags |= ImGuiBackendFlags_HasGamepad.\n\nRead instructions in debuggui.cpp for details.");
            ...
            if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
            {
                ...
                ImGui::SameLine(); HelpMarker("Set to make all floating debuggui windows always create their own viewport. Otherwise, they are merged into the main host viewports when overlapping it.");
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Text Input"))
    {
        ...
        if (ImGui::TreeNode("Filtered Text Input"))
        {
            struct TextFilters
            {
                ...
                {
                    if (data->EventChar < 256 && strchr("debuggui", (char)data->EventChar))
                        return 0;
                    return 1;
                }
            };
            ...
            static char buf6[64] = ""; ImGui::InputText("\"debuggui\" letters", buf6, 64, ImGuiInputTextFlags_CallbackCharFilter, TextFilters::FilterImGuiLetters);
            ImGui::TreePop();
        }
    ...
    if (ImGui::TreeNode("Data Types"))
    {
        ...
        ImGui::SameLine(); HelpMarker(
            "As with every widget in dear debuggui, we never modify values unless there is a user interaction.\n"
...
static void ShowDemoWindowPopups()
{
    ...
    if (ImGui::TreeNode("Modals"))
    {
        ...
        if (ImGui::BeginPopupModal("Stacked 1", NULL, ImGuiWindowFlags_MenuBar))
        {
            ...
            // will close the popup. Note that the visibility state of popups is owned by debuggui, so the input value
...
struct MyItem
{
    ...
    // As we don't rely on std:: or other third-party library to compile dear debuggui, we only have reliable access to qsort(),
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    // types and ImVec2/ImVec4. Dear ImGui defines overloaded operators but they are internal to debuggui.cpp and not
