...
// See the series of events below and the corresponding state reported by dear debuggui:
//------------------------------------------------------------------------------------------------------------------------------------------------
...
{
    // Read debuggui.cpp "API BREAKING CHANGES" section for 1.78 if you hit this assert.
...
int ImGui::PlotEx(ImGuiPlotType plot_type, const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, ImVec2 frame_size)
{
    ...
    // Return hovered _indicesIndex or -1 if none are hovered.
